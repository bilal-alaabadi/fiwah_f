          ...
          {data.image && data.image.length > 0 ? (
            <>
              ...
              <div className="mt-4 w-full">
                <div className="flex gap-3 flex-wrap justify-center overflow-x-auto py-1">
                    ...
                    <button
                      ...
                      className={`rounded-md border-2 p-0 overflow-hidden transition ${
                        index === currentImageIndex
                          ? 'border-[#d3beaa]'
                          : 'border-transparent hover:border-[#d3beaa]/60'
                      }`}
                      type="button"
                    >
                      <img
        ...
        <div className="md:w-1/2 w-full text-center">
          ...
          {data.size && (
            <p className="text-gray-700 mb-3">
              جرام / مل: <span className="font-semibold">{data.size}</span>
            </p>
          )}
          ...
          <div className="mb-6 flex items-center justify-center gap-4">
            <button
              ...
              className={`w-10 h-10 flex items-center justify-center rounded-md text-white ${
                isOutOfStock ? 'bg-gray-300 cursor-not-allowed' : 'bg-[#d3beaa]'
              }`}
